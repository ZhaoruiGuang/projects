...
const routes = {		 						
	...
	staticProduct 	 : '../build/assets/', 								 							
	templatesProduct : '../build/views/', 
};
const files = {
	htmls     		 : ['./src/views/**/*.html'], 		// 原始 html 文件，下面 get-internal-file 任务中做处理									
	manifest  		 : ['./webpack-assets.json'], 						
	statics 		 : ['./assets/**/*.*'],
	devTemplates 	 : ['./dist/**/*.*'],
	proTemplates 	 : ['../build/views/**/*.*'],
	proAssets	 	 : ['../build/assets/**/*.*'],
};
